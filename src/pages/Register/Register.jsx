            ...
            <Formik>
                <Form className="register__form" onSubmit={handleSubmit}>
                    ...
                    <div className={touched.taiKhoan && errors.taiKhoan ? "form__item animation" : "form__item group-1"}>
                        ...
                        <div className="form__group">
                            <div className="form__input">
                                <Field type="text" id="userName" name="taiKhoan" placeholder="Tài khoản..." onChange={handleChange} onBlur={handleBlur} />
                    ...
                    <div className={touched.matKhau && errors.matKhau ? "form__item animation" : "form__item group-1"}>
                        ...
                        <div className="form__group">
                            <div className="form__input">
                                <Field type={showPassword ? "text" : "password"} id="password" name="matKhau" placeholder="Mật khẩu..." onChange={handleChange} onBlur={handleBlur} />
                    ...
                    <div className={touched.passwordConfirm && errors.passwordConfirm ? "form__item animation" : "form__item"}>
                        ...
                        <div className="form__group">
                            <div className="form__input">
                                <Field type={showPasswordConfirm ? "text" : "password"} id="passwordConfirm" name="passwordConfirm" placeholder="Xác nhận mật khẩu..." onChange={handleChange} onBlur={handleBlur} />
                    ...
                    <div className={touched.hoTen && errors.hoTen ? "form__item animation" : "form__item"} >
                        ...
                        <div className="form__group">
                            <div className="form__input">
                                <Field type="text" id="firstName" name="hoTen" placeholder="Họ tên..." onChange={handleChange} onBlur={handleBlur} />
                    ...
                    <div className={touched.soDt && errors.soDt ? "form__item animation" : "form__item"} >
                        ...
                        <div className="form__group">
                            <div className="form__input">
                                <Field type="text" id="phone" name="soDt" placeholder="Số điện thoại..." onChange={handleChange} onBlur={handleBlur} />
                    ...
                    <div className={touched.email && errors.email ? "form__item animation" : "form__item"}>
                        ...
                        <div className="form__group">
                            <div className="form__input">
                                <Field type="text" id="email" name="email" placeholder="Email..." onChange={handleChange} onBlur={handleBlur} />
                    ...
                    <div className="form__button">
                        {!isValid ?
                            ...
                            :
                            <button type="submit" className={btnLoading ? "button button-loading" : "button"} disabled={!isValid} onClick={() => {
                                dispatch({
                                    type: "openBtnLoading",
                                })
                            }}>
